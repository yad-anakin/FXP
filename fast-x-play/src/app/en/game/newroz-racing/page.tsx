...
const game = {
  id: 'newroz-racing',
  title: 'Newroz Racing',
  description: 'A racing game inspired by the Kurdish New Year festival of Newroz and Kurdish culture. Race with fast cars through the beautiful landscapes of Kurdistan and become the champion.',
  shortDescription: 'Racing game with the spirit of Newroz festival',
  image: '/games/newroz-racing-placeholder.jpg',
  steamLink: '#',
  features: [
    'Showcasing the beautiful natural landscapes of Kurdistan',
    'More than 20 different cars to choose from',
    'Multiple tracks each featuring different Kurdish celebrations and festivals',
    'Advanced scoring system for collecting points and competing with friends'
  ],
  galleryImages: [
  ...
  blogContent: `
    <p>Newroz Racing is a game that brings together racing enthusiasts and Kurdish culture. In this exciting racing experience, you can speed through the most beautiful scenery in Kurdistan.</p>
    <p>In each track, you'll see a special Kurdish celebration, from Newroz festivities to New Year's rituals and other holidays. It's an opportunity to enjoy racing while gaining knowledge about Kurdish culture.</p>
    <p>The game includes several gameplay modes, including: Training, Competition, Solo mode, and Story adventure. You can upgrade your car and use various features and colors.</p>
    <p>Our main goal is to create an engaging game that's both fun and showcases Kurdish culture in a positive light.</p>
  `
};
